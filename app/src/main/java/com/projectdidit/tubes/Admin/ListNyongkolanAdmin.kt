...
class ListNyongkolanAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_nyongkolan_admin)
        btn_Tambah = findViewById(R.id.btn_tambah_nyongkolan_admin)
        btn_Tambah.setOnClickListener{
            val intent = Intent(this@ListNyongkolanAdmin, TambahDataActivity::class.java)
            startActivity(intent)
        }
        rv_list = findViewById(R.id.rvAdmin)
        rv_list.setHasFixedSize(true)
        ref = FirebaseDatabase.getInstance().getReference("Nyongkolan")
        rv_list.layoutManager = LinearLayoutManager(this)

        val listwisata = AdminAdapter(list)
