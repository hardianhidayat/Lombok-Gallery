...
class ListMallAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_mall_admin)
        btn_Tambah = findViewById(R.id.btn_tambah_mall_admin)
        btn_Tambah.setOnClickListener{
            val intent = Intent(this@ListMallAdmin, TambahDataActivity::class.java)
