...
class AdminAdapter (private val listMenu: ArrayList<ListPariwisata>) : RecyclerView.Adapter<AdminAdapter.ListViewHolder> () {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ListViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(R.layout.rv_admin, viewGroup, false)
