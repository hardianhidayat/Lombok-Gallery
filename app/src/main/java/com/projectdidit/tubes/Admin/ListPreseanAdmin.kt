...
class ListPreseanAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_presean_admin)
        btn_Tambah = findViewById(R.id.btn_tambah_presean)
        btn_Tambah.setOnClickListener{
            val intent = Intent(this@ListPreseanAdmin, TambahDataActivity::class.java)
            startActivity(intent)
        }
        rv_list = findViewById(R.id.rvAdmin)
        rv_list.setHasFixedSize(true)
        ref = FirebaseDatabase.getInstance().getReference("Presean")
