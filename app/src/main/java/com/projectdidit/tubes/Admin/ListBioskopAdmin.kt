...
class ListBioskopAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_list_bioskop_admin)
        btn_Tambah = findViewById(R.id.btn_tambah_bioskop_admin)
        btn_Tambah.setOnClickListener{
            val intent = Intent(this@ListBioskopAdmin, TambahDataActivity::class.java)
            startActivity(intent)
        }
        rv_list = findViewById(R.id.rvAdmin)
        rv_list.setHasFixedSize(true)
        ref = FirebaseDatabase.getInstance().getReference("Bioskop")
